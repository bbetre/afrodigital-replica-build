  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="professional-card p-12 md:p-16 rounded-2xl border border-border/50">
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    Founded in 2023, AfroDigital emerged from a vision to bridge the gap between businesses and transformative technology. What started as a small team of passionate developers has grown into a full-service digital agency serving clients worldwide.
                  </p>
                  <p>
        ...
        {/* Values Section */}
        <section ref={sectionRef} className="py-16 relative overflow-hidden bg-primary/5">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`group relative professional-card p-8 rounded-2xl border border-border/50 hover:border-accent/30 transition-all duration-500 hover:shadow-elevated hover:-translate-y-2 overflow-hidden ${isVisible ? 'animate-fade-in-up' : 'opacity-0'
                      }`}
