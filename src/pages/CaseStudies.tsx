...
const caseStudies = [
  ...
  },
  {
    ...
    client: "IndustrialTech Co",
    category: "Manufacturing",
    challenge: "Inefficient production monitoring and high operational costs",
    solution: "Implemented IoT sensors and AI-powered predictive maintenance system",
    results: [
      { metric: "Downtime Reduction", value: "-85%", icon: Zap },
      { metric: "Cost Savings", value: "$1.2M/year", icon: TrendingUp },
      { metric: "Productivity", value: "+45%", icon: Users },
    ],
  ...
  },
  {
    ...
    client: "LearnNow Academy",
    category: "Education",
    challenge: "Low student engagement and limited learning resources",
    solution: "Created an interactive learning platform with gamification and personalized learning paths",
    results: [
      { metric: "Student Engagement", value: "+320%", icon: Users },
      { metric: "Course Completion", value: "89%", icon: TrendingUp },
      { metric: "Learning Speed", value: "2x faster", icon: Zap },
    ],
    technologies: ["React", "WebRTC", "Gamification", "Analytics"],
  ...
  },
  {
    ...
    solution: "Built an AI-powered route optimization system with real-time tracking",
    results: [
      { metric: "Fuel Savings", value: "-40%", icon: Zap },
      { metric: "Delivery Speed", value: "+60%", icon: TrendingUp },
      { metric: "Customer Satisfaction", value: "94%", icon: Users },
    ],
    technologies: ["Machine Learning", "GPS", "React", "Node.js"],
